...
<div class="flex-1 flex flex-col items-center justify-center gap-8">
  ...
  <p class="{useInterest ? "" : "hidden"}">When you set these, the figures you see will be the post growth figures adjusted for inflation to today.</p>
  <div class="flex flex-row gap-8 {useInterest ? "" : "hidden"}">
    <div class="w-96">
